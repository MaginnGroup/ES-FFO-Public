...
17. Claude_Audit/ contains the files generated by Claude to audit the experimental data is esolvs.py and generate the data for Tables 4, 8, and 9 in the main text. <br />
