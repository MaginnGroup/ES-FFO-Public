...
17. Claude_Audit/ contains the files generated by Claude to audit the experimental data is esolvs.py and generate the data for Tables 7 and 8 in the main text. <br />
...
9. recomputed_metrics.csv: The R1 and R2 metrics used in Tables 7 and 8 and SI Tables S2 and S3
...
14. student_ff_recompute: Error data generated by the Claude Audit. The data in Tables 7 and 8 and SI Tables S2 and S3
15. tables_6_7_reconstructed.tex: Tables 7 and 8 in the main text
...
2. build_reference_values_all.py: Generated the R1 and R2 metric reference values used in Tables 7 and 8 and SI Tables S2 and S3
...
5. generate_tables.py: Generates Tables 7 and 8 and SI Tables S2 and S3 in the main text
6. plot_baseline_vs_experiment.py: Generates experimental data comparison figures
7. recompute_metrics_all.py: Recomputes error metrics for predictions. Generates the data in Tables 7 and 8 and SI Tables S2 and S3 in the main text
