...
val_group = ProjectVleVal.make_group(name="Val")
...
def run_gemc(job):
    ...
    try:
        ...
        # if GEMC failed with critical conditions as intial conditions, terminate with error
            ...
            if job.doc.use_crit == False:
                # If GEMC fails, remove files and post conditions of previous operations
                delete_data(
                    job,
                    custom_args_gemc["run_name"],
                    mv=True,
                ...
                raise Exception("GEMC failed with critical and normal conditions")
